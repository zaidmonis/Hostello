...
public class CouncilCulturalSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass danceSecy=new CouncilUserClass("Yash Doshi","Institute Dance Secretary",""," 160020001@srms.ac.in",R.drawable.yash_doshi);
        CouncilUserClass filmSecy=new CouncilUserClass("Gautam Jagdhish","Institute Film and Media Secretary",""," 170010031@srms.ac.in",R.drawable.gautam_jagdish);
        CouncilUserClass musicSecy=new CouncilUserClass("Saurav Nitin Dosi","Institute Music Secretary","","170030006@srms.ac.in",R.drawable.souravdoshi);
        CouncilUserClass artSecy=new CouncilUserClass("Deeksha N","Institute Fine Arts Secretary","","160010033@srms.ac.in",R.drawable.deeksha);
