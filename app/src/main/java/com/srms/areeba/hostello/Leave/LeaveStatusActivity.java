...
import com.srms.areeba.hostello.Complaints.ComplainItemClass;
import com.srms.areeba.hostello.Complaints.ComplainStatus;
import com.srms.areeba.hostello.Complaints.ComplaintsAdapter;
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        if(leave!=null){
                            ...
                            if(Objects.requireNonNull(statusUser.getEmail()).equalsIgnoreCase("admin@srms.ac.in")){
                                ...
                                if(leave.getName().equalsIgnoreCase(statusUser.getDisplayName())){
                                    leaves.add((leave));
                                }
                            }
