...
public class AdminLeaveActivity extends AppCompatActivity {
    ...
    private AdminLeavesAdapter statusAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = findViewById(R.id.leave_status_listview_admin);
        mShimmerViewContainer = findViewById(R.id.shimmer_view_container_admin);
        ...
        if(statusUser==null){
            startActivity(new Intent(AdminLeaveActivity.this, LoginActivity.class));
            finish();
        }


        statusAdapter = new AdminLeavesAdapter(this, leaves, keys);
