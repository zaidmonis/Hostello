package com.srms.areeba.hostello.User;
...
public class UserClass {
    ...
    public UserClass( String userEmail,String uname,String userBranch,String userYear, String userPhone,String userDob,  String userGender,String userHostel,String userPic,String userCoverPic, String userType) {
        email = userEmail;
        name = uname;
        phone = userPhone;
        gender = userGender;
