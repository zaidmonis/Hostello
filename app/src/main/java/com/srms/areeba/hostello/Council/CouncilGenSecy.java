...
public class CouncilGenSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass genAcSecy=new CouncilUserClass("Shruti Patel","Academic General Secretary",""," 160010002@srms.ac.in",R.drawable.shruti_patel);
        CouncilUserClass genCulSecy=new CouncilUserClass("Mehul Bose","Cultural General Secretary",""," 170030010@srms.ac.in",R.drawable.mehul_bose);
        CouncilUserClass genTechSecy=new CouncilUserClass("Samveed Desai","Technical General Secretary",""," 160020003@srms.ac.in",R.drawable.samveed_desai);
        CouncilUserClass genSportSecy=new CouncilUserClass("Nikhilesh Kumar Thakur","Sports General Secretary",""," 160030024@srms.ac.in",R.drawable.nikhilesh);
